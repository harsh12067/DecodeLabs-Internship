  ...
  projects: [
    {
      ...
      description:
        'A comprehensive academic portal for tracking student data, records, course registration, attendance, grades, and generating reports. Designed with a clean admin dashboard and robust roles.',
      ...
      highlights: [
        ...
        'Student record tracking and grade management',
        'Attendance and report generation',
      ],
    },
    {
      id: 2,
    ...
    },
    {
      ...
      description:
        'A premium full-featured digital shopping application including cart functionality, dynamic product listings, search/filters, authentication, and structured checkout flow.',
      technologies: ['React.js', 'Tailwind CSS', 'MongoDB', 'Node.js', 'Express.js'],
      category: ['fullstack', 'MERN', 'web', 'React'],
      liveLink: null,
      githubLink: null,
      highlights: [
        'Shopping cart and product listings',
